...
def main():
    ...
    QWEN36_BASE = {
        "128": float(os.environ.get("SPARKINFER_QWEN36_128", "254.72")),
        "512": float(os.environ.get("SPARKINFER_QWEN36_512", "251.87")),
        "4k":  float(os.environ.get("SPARKINFER_QWEN36_4K",  "239.0")),
